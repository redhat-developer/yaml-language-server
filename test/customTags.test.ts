...
suite('Custom Tag tests Tests', () => {
  ...
  before(() => {
    ...
    const { languageService: langService, validationHandler: valHandler, languageHandler: _, yamlSettings: __ } = setupLanguageService(languageSettingsSetup.languageSettings);
