 ...
 *--------------------------------------------------------------------------------------------*/
import { LanguageSettings, SchemasSettings } from '../../src/languageservice/yamlLanguageService.js';
import { YamlVersion } from '../../src/languageservice/parser/yamlParser07.js';
