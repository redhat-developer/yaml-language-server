...
suite('Document Symbols Tests', () => {
  ...
  describe('Document Symbols Tests (Hierarchical)', function () {
    ...
    it('Document Symbols with complex mapping and aliases', () => {
      ...
      const element = createExpectedDocumentSymbol(
        'element',
        SymbolKind.String,
        5,
        16,
      ...
      const root1 = createExpectedDocumentSymbol(
        'root',
        SymbolKind.Module,
        3,
        22,
      ...
      const height = createExpectedDocumentSymbol(
        'height',
        SymbolKind.Number,
        10,
        18,
      ...
      const style = createExpectedDocumentSymbol(
        'style',
        SymbolKind.Module,
        9,
        16,
      ...
      const root2 = createExpectedDocumentSymbol(
        'root',
        SymbolKind.Module,
        7,
        17,
      ...
      assert.deepEqual(
        symbols[1],
        createExpectedDocumentSymbol('structure', SymbolKind.Module, 2, 12, 5, 28, 2, 12, 2, 21, [
          root1,
        ])
      );
      ...
      assert.deepEqual(
        symbols[2],
        createExpectedDocumentSymbol('conditions', SymbolKind.Module, 6, 12, 10, 28, 6, 12, 6, 22, [
          root2,
        ])
      );
    });
