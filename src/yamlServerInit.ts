...
export class YAMLServerInit {
  ...
  constructor(private readonly connection: IConnection, yamlSettings: SettingsState, workspaceContext: any, schemaRequestService: any) {
    this.yamlSettings = yamlSettings;

    this.languageService = getCustomLanguageService(schemaRequestService, workspaceContext);
    ...
    this.connection.onInitialize(
      (params: InitializeParams): InitializeResult => {
        ...
        this.yamlSettings.hasWorkspaceFolderCapability = this.yamlSettings.capabilities.workspace && !!this.yamlSettings.capabilities.workspace.workspaceFolders;
        return {
          capabilities: {
