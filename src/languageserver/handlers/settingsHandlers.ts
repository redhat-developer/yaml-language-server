...
export class SettingsHandler {
  ...
  constructor(private readonly connection: IConnection, private readonly languageService: LanguageService, private readonly yamlSettings: SettingsState, private readonly validationHandler: ValidationHandler) {
  ...
  /**
     ...
     */
  private configurationChangeHandler(change: DidChangeConfigurationParams) {
