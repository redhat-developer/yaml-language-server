...
import { ASTNode, ErrorCode, BooleanASTNode, NullASTNode, ArrayASTNode, NumberASTNode, ObjectASTNode, PropertyASTNode, StringASTNode, JSONDocument } from './jsonParser04';
    ...
    switch (node.kind) {
        ...
        case Yaml.Kind.SEQ: {
            ...
            for (const item of instance.items) {
                ...
                const itemNode = (item === null) ? new NullASTNode(parent, null, instance.endPosition, instance.endPosition) : recursivelyBuildAst(result, item);
